...
Заверши мысль так, чтобы текст выглядел законченно, без обрыва на полуслове.
""",
        "straight_news": """
Структура:
...
ТРЕБОВАНИЯ:
• Длина: ОТ 650 до 850 символов (не меньше 650 и не больше 850).
• Только русский язык.
...
ЗАПРЕЩЕНО:
• Любые призывы: «попробуйте», «оцените», «не пропустите» и т.п.
• Оценки: «революционный», «потрясающий», «лучший», «убийца» и подобные усилители.
• Восклицательные знаки (максимум один, лучше без них).
            ...
            messages=[
                {
                    "role": "system",
                    "content": (
                        "Ты — новостной редактор. Пишешь по фактам, без рекламы, "
                        "но допускаешь аккуратное использование эмодзи только для визуального оформления."
                    )
                },
